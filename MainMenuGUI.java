...
public class MainMenuGUI extends JFrame {
    ...
    private ArrayList<Item> sharedItems; 
    ...
    public MainMenuGUI() {
        ...
        menuItems.add("Expiration Tracking");
        ...
        button.addActionListener(e -> {
            switch (text) {
                ...
                case "Demand Forecasting":
                    ...
                    break;
                case "Expiration Tracking":
                    JOptionPane.showMessageDialog(null, "Expiration Tracking selected.");
                    break;
    ...
    private void openInventoryManagement() {
        new InventoryManagementGUI(sharedItems); // Opens the Inventory Management window
        dispose(); // Close the current Main Menu window
    }

    // Method to open Stock Management GUI
    private void openStockManagement() {
        new StockManagementGUI(sharedItems); // Opens the Stock Management window
        dispose(); // Close the current Main Menu window
    }
